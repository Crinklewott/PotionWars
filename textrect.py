...
#Modified by AKA, to move the generated final_lines into a function. Then, if there is an exception, we can get the lines that fit onto the rectangle, to ease generation
#of additional pages.
...
def get_final_lines(string, font, rect):
    """
        Returns the list of lines that have been generated to fit onto the passed rectangle.    
    """
...
def render_textrect(string, font, rect, text_color, background_color, justification=0):
    ...
    # rectangle.
    final_lines = get_final_lines(string, font, rect)
