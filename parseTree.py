...
inlineCommandsPlayer = {
    ...
    r'\pjcladbottom':("universal.state.player.pj_clad_bottom(",),
    ...
    r'\liftslowers': ("items.liftslowers(universal.state.player.lower_clothing())",),
...
inlineCommands = {
    ...
    r'\npcweapon':("person.weapon_name(", 1),
    r'\npcheight':("person.height_based_msg(", 5),
    r'\npcbodyType':("person.bodytype_based_msg(",5),
    r'\npcmusculature':("person.musculature_based_msg(",4),
    r'\npchairlength':("person.hair_length_based_msg(",5),
    r'\npcpjtype': ("items.dropseat_based_msg(", 3),
    r'\npcisliftedlowered':("items.liftlowered_based_msg(", 3),
    r'\npcisloweredlifted':("items.loweredlifted_based_msg(", 3),
    r'\npcisliftedlowered':("items.liftlowered_based_msg(", 3),
