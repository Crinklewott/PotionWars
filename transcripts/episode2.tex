...
\begin{openScene}
    ...
    if not loading:
        ...
        textCommandsMusic.enterLeft(airell, guild)
...
\begin{childnode}{ep2 guild wake up}{Andrew Russell}
    ...
    \music{textCommandsMusic.ALONDRA}
...
\begin{node}{ep2 airell}{Adventurer's Guild}{Airell}{Andrew Russell}
    ...
    \childif{'punched\_Airell' in textCommandsMusic.keywords()}{ep2 airell face punch}

    \childelif{'talk\_with\_Airell' in textCommandsMusic.keywords()}{ep2 airell talk}
...
\begin{childnode}{ep2 airell wait}{Bonemouth the Boxfish}
    ...
    \cond{'spar\_with\_Cosima' in textCommandsMusic.keywords()}{"Doesn't surprise me. Don't forget we've still got a little sparring match, you and I. Though you might want to wait a few days. My 
...
\cond{'talk\_with\_Airell' in textCommandsMusic.keywords()}{"Now," says Airell. "You will receive your promised paddling. And just in case you think I may have forgotten,  I recall guaranteeing you 
'a thorough paddling that will have you crying and begging me to stop afore we are even half done!'"}{} 

\cond{'talk\_with\_Airell' in textCommandsMusic.keywords()}{\name{} moans. \HeShe{} has nothing more to say as \heshe{} silently curses the uncanny memory of this old fart.}{} 
