...
\begin{node}{ep2 wakeup}{Adventurer's Guild or Maria's Home}{Self}{Andrew Russell}
   ...
   \childif{'boarding\_with\_Adrian' in textCommandsMusic.keywords()}{ep2 guild wake up}

    \childelif{'boarding\_with\_Maria' in textCommandsMusic.keywords()}{ep2 marias wake up}

\end{node}

\begin{childnode}{ep2 guild wake up}{Andrew Russell}

    \childif{'extrovert' in textCommandsMusic.keywords()}{ep2 extrovert}

    \childelif{'introvert' in textCommandsMusic.keywords()}{ep2 guild introvert}
...
\begin{childnode}{ep2 extrovert}{Andrew Russell}
    ...
    \music{textCommandsMusic.CARRIE}
...
\begin{childnode}{ep2 take carrie home female}{Andrew Russell}
    ...
    starts to bounce her bottom up and down, and \name{} groans. \HeShe{} guides Carrie towards \hisher{} \cond{'boarding\_with\_Adrian' in textCommandsMusic.keywords()}{bed}{blankets}. \HeShe{} pushes the young student 
    ...
    \childif{'boarding\_with\_Adrian' in textCommandsMusic.keywords()}{ep2 take carrie home guild}

    \childelif{'boarding\_with\_Maria' in textCommandsMusic.keywords()}{ep2 take carrie home maria}
...
\begin{childnode}{ep2 take carrie home male}{Andrew Russell}
    ...
    \cond{'taking\_Carrie\_home' in textCommandsMusic.keywords()}{"I get to be on top this time. Gonna ride you like a pony."}{"Took you long enough. I was starting to get impatient."}

    \cond{'taking\_Carrie\_home' in textCommandsMusic.keywords()}{"Oh? Where are we going?" asks \name{}, kissing Carrie again.}
    ...
    \cond{'taking\_Carrie\_home' in textCommandsMusic.keywords()}{"And people call me cheeky," says Carrie. She starts to tug \name{} towards the street. "Come on. It's sexy time."}
    ...
    \cond{'taking\_Carrie\_home' in textCommandsMusic.keywords()}{"That's because you are cheeky," says \name{}, lightly smacking Carrie's bottom.}{\name{} cranes \hisher{} neck to look up at the 
    cloudy night sky. "How can you tell?"}

    \cond{'taking\_Carrie\_home' in textCommandsMusic.keywords()}{Carrie sticks her tongue out at \himher{}.}{"Magic."}
    ...
    \cond{'boarding\_with\_Adrian' in textCommandsMusic.keywords()}{bed}{blankets}, they half-fall, half-kneel onto the blankets. Carrie gives \name{} a light shove, pushing \himher{} onto \hisher{} back. She straddles \himher{}, 
...
\begin{childnode}{ep2 take carrie home guild}{Andrew Russell}
    ...
    \cond{'taking\_Carrie_home' in textCommandsMusic.keywords()}{again}{}."
...
\begin{childnode}{ep2 ildri double spanking apologize}{Andrew Russell}
    ...
    \cond{universal.state.player.underwear().is\_baring()}{teeny}{thin} \underwear{} and tugs \itthem{universal.state.player.underwear()} down to \names{} knees.}{}
    ...
    Finally, Ildri gives them another overlapped slap, then rolls her eyes at Carrie. "Two \cond{universal.state.player.s\_female()}{girls}{young adults} sharing a room, and they don't set up sex rules? What is up with 
    kids these days?" 
...
\begin{childnode}{ep2 carrie extrovert refuse spank sissy}{Andrew Russell}
    ...
    \childif{'boarding\_with\_Adrian' in textCommandsMusic.keywords()}{ep2 guild wake up no carrie}

    \childelif{'boarding\_with\_Maria' in textCommandsMusic.keywords()}{ep2 maria wake up no carrie}
...
\begin{childnode}{ep2 carrie extrovert refuse spank stern}{Andrew Russell}
    ...
    g-string. 
    \cond{'Samantha\_saw\_Carries\_dress' in textCommandsMusic.keywords()}{\name{} shakes \hisher{} head. "Didn't Sister Samantha spank you good for wearing a g-string? Don't you ever learn?"}{"One 
        thing I'll say about you Carrie, you sure make it easy to bare your bottom."}

    \cond{'Samantha\_saw\_Carries\_dress' in textCommandsMusic.keywords()}{"I'm an adult," says Carrie snottily. "I can wear whatever I want."}{"Oh shut up and get this over with," says Carrie. "I don't need your mockery."}
...
\begin{childnode}{ep2 extrovert refuse Carrie adamantly}{Andrew Russell}
    ...
    \childelif{'boarding\_with\_Adrian' in textCommandsMusic.keywords()}{ep2 maria wake up no carrie}
...
\begin{childnode}{ep2 extrovert carrie refuse not interested}{Andrew Russell}
    ...
    \cond{'taking\_Carrie\_home' in textCommandsMusic.keywords()}{"I thought...you know, last month when we--"}{"I thought...I mean, we were having so much fun together..."} says Carrie, her voice faltering.

    \cond{'taking\_Carrie\_home' in textCommandsMusic.keywords()}{"Yeah, I know. Maybe we rushed into it, or something. But I mean, at the time there weren't really any expectations of anything serious right? Just some fun? I thought maybe it could become 
...
\begin{childnode}{ep2 guild no bar tantrum}{Andrew Russell}
    ...
    As soon as the others have left, Ildri grabs \names{} forearm, spins \himher{} around, and lands two hard smacks to the seat of \hisher{} \trousers{}. "What the hell do you think you're doing? This place is enough of a mess already without you throwing a 
    tantrum."
...
\begin{childnode}{ep2 guild no bar drink start}{Andrew Russell}
    ...
    stabbing me, burning me, \cond{'spanked\_by\_Necia' in textCommandsMusic.keywords() or 'spanked\_by\_Necia\_with\_sandal' in textCommandsMusic.keywords()}{spanking me."}{throwing me all over the 
    guild."}
...
\begin{childnode}{ep2 maria to sofias carrie leaves}{Andrew Russell}
    ...
    The next morning opens with Carrie scooping up her dress, and hunting for her slippers. \name{} rolls onto \hisher{} side, \cond{'ep2CarrieSexSpanking' in textCommandsMusic.keywords}{wincing a little as \hisher{} bruised bottom twinges.}{smiling as
...
\begin{childnode}{ep2 maria no bar bratty}{Andrew Russell}
    ...
    \cond{'Maria\_spanked\_you' in textCommandsMusic.keywords()}{"Of course. Threaten me with a spanking. That's all you ever do isn't it? You say 'No' I say 'Yes' you spank me into submission. Get buried."}{"What do you care anyway? I'm an adult, I know the 
    risks. Let me live my life."}

    \cond{'Maria\_spanked\_you' in textCommandsMusic.keywords()}{"I'm trying to protect you," says Maria. "I won't just sit by and let you ruin your life. I've gone through that once already, and I won't go through
...
\begin{node}{ep2 clinic}{Sofia's Clinic}{Sofia}{Andrew Russell}
    ...
    "A pleasure," says \name{}, smiling politely. \cond{'met\_Paloma' in textCommandsMusic.keywords()}{There's something about Sofia that tickles \names{} memory. Something about her voice, or her mannerisms. Maybe her face.}{}
    ...
    \cond{'ep2WrongWay' in textCommandsMusic.keywords()}{"Just about,"}{"Actually, \heshe{} came without a fuss,"} says Maria.
    ...
    \pwearingdress{\shirt{}.}{\shirt{} and \trousers{}.} "I'd never let my \isfemale{granddaughter}{grandson} go out like that. Least not without feeling the sting of my hand on \hisher{} backside."}
    ...
    \begin{code}
        ...
        bedroom = universal.state.get\_room("Maria's Home")
        ...
        universal.state.player.add\_keyword('ep2VisitedClinic')
...
\begin{node}{ep2 ildri chat}{Adventurer's Guild}{Ildri}{Andrew Russell}
    ...
    \childif{'risqueScene' not in textCommandsMusic.keywords() and universal.state.player.risque() >= 4 and 'Ildri\_no\_pants' in textCommandsMusic.keywords()}{ep2 ildri indecent no pants}

    \childelif{'risqueScene' not in textCommandsMusic.keywords() and universal.state.player.risque() >= 4}{ep2 ildri indecent}
...
\begin{childnode}{ep2 ildri indecent}{Andrew Russell}
    ...
    "Hey." \name{} approaches Ildri, and takes a deep breath of the savory smell of baking bread that fills the kitchen. "Hmm, that smells good."
...
\begin{childnode}{ep2 ildri hate sewing}{Andrew Russell}
    ...
    \cond{'attractedToAlondra' in textCommandsMusic.keywords() and 'lesbian\_in\_denial' in textCommandsMusic.keywords()}{\name{} feels a brief stab of regret. Was that dissapointment in Alondra's 
        voice? Perhaps \heshe{} said-No, of course not. No way \heshe{} could be serious.}{}

    \cond{'attractedToAlondra' in textCommandsMusic.keywords() and 'lesbian\_in\_denial' not in textCommandsMusic.keywords()}{\name{} feels a jolt. Was that disappointment in her voice? Perhaps 
...
\begin{childnode}{ep2 ildri sexy idols female}{Andrew Russell}
    ...
    \cond{'ep2KissedAlondra' in textCommandsMusic.keywords()}{"You know, she makes a good point," says Alondra thoughtfully.}{Alondra's eyes widen. "Really?"}

    \child{"Better believe it. 'Course, they're not as sexy as you."}{ep2 alondra sexy compliment}

    \child{\cond{'ep2KissedAlondra' in textCommandsMusic.keywords()}{"Better believe it. Gotta love the female body."}{"Sure. I appreciate a gorgeous female body as much as the next person."}}{ep2 
        alondra appreciate}
...
\begin{childnode}{ep2 ildri scene 1 chat}{Andrew Russell} 
    ...
    \childif{'ep2IldriSceneTransition' in textCommandsMusic.keywords()}{ep2 ildri scene 1 transition again}
...
\begin{childnode}{ep2 ildri scene 1 transition}{Andrew Russell}
    ...
    adventurers. \cond{'attractedToAlondra' in textCommandsMusic.keywords()}{It didn't help that Alondra and \name{} kept playfully flicking food at each other and playing 
...
\begin{node}{ep2 peter}{Wesley and Anne's Weapons and Armor}{Peter}{Andrew Russell}
    ...
    \childif{'teaching\_Anne' in textCommandsMusic.keywords()}{ep2 peter teaching anne}
...
\begin{childnode}{ep2 peter teaching anne continued}{Andrew Russell}
    ...
    \cond{'attractedToPeter' in textCommandsMusic.keywords()}{"Worried I might ruin your daughter?" says \name{}, smirking at Peter.}{"Ever the protective father," says \name{}.}
...
\begin{childnode}{ep2 anne meditation}{Andrew Russell}
    ...
    "Oh, don't worry about that," says \name{}, sharing a \cond{'ep2AnnePrank' in textCommandsMusic.keywords()}{mischievous grin}{smile} with Anne. "We've got a deal worked out, no problem. Isn't that right, Anne?"
    ...
    \cond{'ep2AnnePrank' in textCommandsMusic.keywords()}{"Can we prank Daddy yet?"}{"Can we make sparkles now?"} asks Anne.

    "Have you completed your meditation yet?" asks \name{}.

    "No..."

    \cond{'ep2AnnePrank' in textCommandsMusic.keywords()}{"Then what makes you think we're ready to prank your father?"}{"Then what makes you think we're ready to play with the sparkles?"} asks \name{}.
    ...
    a glance at Peter, \cond{'attractedToPeter' in textCommandsMusic.keywords()}{admiring his muscled, round bottom as he bends over to peer into the forge}{Anee's father}. \name{} hums a little, and starts to sing.
    ...
    \childif{'ep2AnnePrank' in textCommandsMusic.keywords()}{ep2 anne start prank}
...
\begin{childnode}{ep2 anne start prank}{Andrew Russell}
    ...
    \name{} \cond{'attractedToPeter' in textCommandsMusic.keywords()}{blushes. "Well, alright."}{grins. "Devious child."}
...
\begin{childnode}{ep2 peter run for it}{Andrew Russell}
    ...
    \cond{'attractedToPeter' in textCommandsMusic.keywords() and universal.state.player.is\_female()}{"Ladies first?" says \name{}, smiling weakly.}{\name{} lowers \hisher{} head and scurries inside.}
    \cond{'attractedToPeter' in textCommandsMusic.keywords() and universal.state.player.is\_female()}{\names{} smile fades beneath Peter's harsh glare. \HeShe{} lowers \hisher{} head and ducks into the shed.}{}
    ...
    \name{} bends over and puts \hisher{} hands on the stool. \HeShe{} locks \hisher{} knees, and thrusts \hisher{} tender, pinkish, \bumadj{} bottom towards Peter. \cond{'attractedToPeter' in textCommandsMusic.keywords()}{\name{} is surprised by a faint
    ...
    "It's over." \cond{'attractedToPeter' in textCommandsMusic.keywords()}{Peter sets the cane back in its hooks on the wall, and gently pries \names{} fingers off the stool. Then, to \names{} surprise, he sits down on the stool, his legs open, and guides 
...
\begin{childnode}{ep2 peter wait}{Andrew Russell}
    ...
    \cond{'attractedToPeter' in textCommandsMusic.keywords()}{Peter probably hates me now. W-well, well he should. Because I'm stupid. I'm a horrible, stupid little--"}{}
...
\begin{childnode}{ep2 anne play}{Andrew Russell}
    ...
    \childif{'attractedToPeter' in textCommandsMusic.keywords()}{ep2 peter small conversation}
...
\begin{node}{ep2 elise prologue}{Shrine}{Elise}{Andrew Russell}
    ...
    \name{} enters the orphanage, and asks one of the nearby Brothers about the location of Elise. The Brother points towards Sister Samantha's office at the end of the 
    hall. \name{} makes \hisher{} way to the door, and knocks.
    
    "Come in," calls Sister Samantha's voice.

    \name{} pushes the door open and enters.

    \childif{'second\_hand\_tragedy' in textCommandsMusic.keywords()}{ep2 elise second hand tragedy}
...
\begin{node}{ep2 carrie}{offStage}{Carrie}{Andrew Russell}
    ...
    \childif{'ep2BeginningLostTemperWithCarrie' in textCommandsMusic.keywords()}{ep2 carrie lost temper apologize}
...
\begin{childnode}{ep2 carrie lost temper paddle}{Andrew Russell}
    ...
    \cond{'attractedToCarrie' in textCommandsMusic.keywords()}{setting off a little fire in \names{} belly.}{trying to get comfortable.}
...
\begin{childnode}{ep2 carrie lost temper refuse to spank}{Andrew Russell}
    ...
    \name{} \cond{'attractedToCarrie' in textCommandsMusic.keywords() and 'lesbian\_in\_denial' not in textCommandsMusic.keywords()}{pulls Carrie into a hug and gives her a kiss on the forehead.}{
...
\begin{childnode}{ep2 carrie subplot begin}{Andrew Russell}
    ...
    "Hey," says Carrie. She gives \name{} a quick \cond{'relationshipWithCarrie' in textCommandsMusic.keywords()}{hug, and kiss.}{hug.} "Sorry for the wait, I was in the lab with Sister Terese."

    "No big deal. Working your terrible potion magic as usual?" asks \name{}, \cond{'relationshipWithCarrie' in textCommandsMusic.keywords()}{giving Carrie's shoulders a squeeze.}{leaning against
    the closest pew.}
...
\begin{childnode}{ep2 carrie illegal}{Andrew Russell}
    ...
    \child{"Hmm. Sister Samantha would probably bail you out, but she might not me. Guess I'll distract everyone. Being a whiny customer isn't illegal, after 
    all."}{ep2 carrie agree}
...
\begin{childnode}{ep2 carrie refuse}{Andrew Russell}
    ...
    \cond{'relationshipWithCarrie' in textCommandsMusic.keywords()}{Carrie pouts for a moment, then sidles up next to \name{}. Her hands slip around \names{} waist, and she pushes her warm hips
    ...
    \cond{'relationshipWithCarrie' in textCommandsMusic.keywords()}{"Trust me, there are plenty of other ways I can make you happy," says \name{}. "Like going for a walk through the fields around
...
\begin{childnode}{ep2 practice spectral magic}{Andrew Russell}
    ...
    By the late afternoon/early evening, both \name{} and Carrie are sweaty, dirty and kind of sore. The two make their slow way back to the Shrine.
    ...
    "Yeah, yeah. Snark snark snark." Carrie sticks her tongue out at \name{}, then disappears into the back of the Church. "See you later!"
...
\begin{childnode}{ep2 carrie subplot spanking}{Andrew Russell}
    ...
    \cond{'ep2BeginningSpankedCarrie' in textCommandsMusic.keywords()}{"Come on \name{}, you can't--oww--solve all your--oww--problems by spanking--oww--me," says Carrie}{"No, come on, not--oww--not
    in public like this. Oww! It's so--oww--embarassing," says Carrie} as her bottom rocks and bobs in a vain effort to evade \names{} hand.

    \cond{'ep2BeginningSpankedCarrie' in textCommandsMusic.keywords()}{"I'm not solving all my problems by spanking you. I'm just teaching you what the word 'no' means," says \name{}.}{"You throw
    ...
    "I'm your \cond{'ep2CarrieSex' in textCommandsMusic.keywords()}{lover}{friend}. That makes you my responsibility," says \name{}. \HeShe{} leans over and administers a burst of heavy slaps to
    ...
    \cond{'ep2BeginningSpankedCarrie' in textCommandsMusic.keywords()}{"I'd be more willing to believe you if I hadn't also paddled you last night," says \name{}.}{"Alright then," 
    says \name{}. "So what now?"}

    \cond{'ep2BeginningSpankedCarrie' in textCommandsMusic.keywords()}{"Hey, that's not fair. That was for something totally different," says Carrie. "And I learned my lesson, see? I haven't 
...
\begin{childnode}{ep2 carrie distraction}{Andrew Russell}
    ...
    \isfemale{Well, nothing like a little bit of lingerie shopping. \cond{'attractedToAlondra'in textCommandsMusic.keywords()}{Maybe there's something here Alondra would enjoy...}{
                \cond{'attractedToPeter' in textCommandsMusic.keywords()}{Maybe there's something here that'd impress Peter... Of course, getting him to see it would be tricky, but whatever. 
...
\begin{childnode}{ep2 carrie agree}{Andrew Russell}
    ...
    "You obnoxious little brat," says Terry, unleashing a flurry of stinging blows. "Of all the inane things to complain about. I suppose if Carol hadn't come up to you, you'd have complained about
     ...
     "You be quiet," says \name{}. \cond{'boarding\_with\_Adrian' not in textCommandsMusic.keywords()}{"Hey Adrian, mind if I borrow a bedroom for a few 
     minutes? Need to have a private chat with my friend."}{\name{} drags Carrie into \hisher{} room.}

     \cond{'boarding\_with\_Maria' in textCommandsMusic.keywords()}{"Your clothes going to stay on?" asks Adrian without looking up from a piece of parchment he is writing on.}{}

     \cond{'boarding\_with\_Maria' in textCommandsMusic.keywords()}{"Well, my clothes will."}{}

     \cond{'boarding\_with\_Maria' in textCommandsMusic.keywords()}{"That'll work. Let me know if you need to borrow an implement. Third door on the left."}{}
     ...
     \cond{'ep2BeginningSpankedCarrie' in textCommandsMusic.keywords()}{bottom through a pair of surprisingly modest white panties.}{bare cheeks,
...
\begin{childnode}{ep2 carrie subplot end}{Andrew Russell}
    ...
    The two walk back to the Shrine.
...
\begin{node}{ep2 intro deidre}{Adventurer's Guild}{Deidre}{Andrew Russell}

    "What are you doing here?" asks \name{} sharply, stepping up to Deidre. 

    Deidre gives \name{} a small smirk. "Why? Afraid I'm gonna arrest you?"

    \childif{'tried\_to\_help\_Edita' in textCommandsMusic.keywords()}{ep2 intro deidre where is edita}

    \childelif{'charmed\_by\_Deidre' in textCommandsMusic.keywords()}{ep2 intro deidre charmed}

    \childelif{True}{ep2 intro deidre other}

\end{node}

\begin{childnode}{ep2 intro deidre where is edita}{Andrew Russell}

    "Where's that girl?" asks \name{}. "What did you do with her?"

    Deidre frowns in confusion. "What girl?"

    "The one you arrested last month. With the birthmark," says \name{}. "Where is she?"

    Deidre rolls her eyes. "Do you have any idea how many girls we arrested at this wretched raid of yours? Hell, do you have any idea how many girls I've arrested period? What the Mother's name 
    makes you think I'd remember any of them? Now leave me be."

    \name{} sets \hisher{} jaw. "Not until you tell me where she is."

    \cond{'charmed\_by\_Deidre' in textCommandsMusic.keywords()}{Deidre leans forward and speaks in a low voice. "I don't know, and I don't care. Now, leave me be. Before I make you."}{"We probably
    let her rot in a dungeon cell for a few weeks,e hooked her, asked her a few questions, then tossed her back on the streets. Just like two-thirds of the Vengadores we arrested. Happy now?"}

    \name{} backs up a step, \hisher{} glare never leaving Deidre. "She was just a girl, barely eighteen."

    "They always are," says Deidre, turning back towards the counter and ignoring \name{}.

\end{childnode}

\begin{childnode}{ep2 intro deidre charmed}{Andrew Russell}

    Deidre's eyes flash, and \name{} thoughts slow. "Now why don't you leave me be. I didn't come here to chat with cocky adventurers who barely know how to hold a sword."

    \name{} backs up step, then spins on \hisher{} heel and walks to the closest unoccupied table. \HeShe{} plops down, and \HeShe{} stares at \hisher{} hands. \HeShe{} folds and unfolds them a few 
    times, then stands and paces about
    the room. The other adventurers glance at \himher{} a few times, but mostly pay \himher{} no mind. Most of them are very carefully ignoring Deidre.

\end{childnode}

\begin{childnode}{ep2 intro deidre other}{Andrew Russell}

    \names{} eyes narrow. "Of course not. I just want to know what the hell gives you the right to burst into my home in the middle of the night."

    Deidre arches an eyebrow in amusement, and her smirk widens. "We're the city guard, and you were chatting it up with the leader of the Vengadores. What, you think we were going to just sit there
    and let you two have your little heart-to-heart? Please. Way I see it, you're lucky Roland didn't make me dig into that empty little head of yours. 
    \cond{'Elise\_shows\_you\_around' in textCommandsMusic.keywords()}{Probably because you're friends with his fiancee. Now, why don't you run off and leave me be. I didn't come here to talk to 
    you."}{Now, why don't you run off and leave me be. I didn't come here to talk to you."}
   
    \name{} backs up, but \hisher{} eyes never leave the Puppeteer. Deidre, meanwhile, turns her back on \name{} and returns to her vigil.
