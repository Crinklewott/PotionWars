...
def display_acknowledgments():
    ...
    universal.say(format_text([['Code, Story, Concept: Andrew Russell'], 
        ...
        ['Beta Testers: Uninventive the Umbrellabird, Johny741 the Jackal, Bonemouth the Boxfish, Flash the Flamingo, Emily the Eccentric Emu, Ken the Kookaburra, Skyblaster the Sardine'],
